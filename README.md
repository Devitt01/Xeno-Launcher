...
Minecraft launcher (non-premium) built with Electron.

## ES

### Estado
- Proyecto en beta para pruebas.
...
- Skins compartidas: `SKIN-HUB-DEPLOY.md`
- Actualizaciones del launcher: `LAUNCHER-UPDATES.md`
